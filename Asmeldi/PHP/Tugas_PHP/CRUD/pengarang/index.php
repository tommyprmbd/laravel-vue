...
<body>
    ...
    <nav class="navbar navbar-light bg-info">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="#" style="position: relative; left: 50px;">Pengarang</a>
        </div>
    </nav>
    <center class="mt-4">
    ...
    <div class="container mt-3">
        <a class='btn btn-primary' href="<?= $url; ?>/pengarang/add.php">Add New Pengarang</a><br /><br />
        <div class="row">
